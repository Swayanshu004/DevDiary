            ...
            <ul className='w-full flex items-center justify-between'>
                <li>
                    <div>
                        ...
                        type="text"
                        placeholder='search' 
                        className='py-1 px-3 rounded-md bg-neutral-800 focus:border-0 font-mono'/></div>
                </li>
                <li><Link href="#" className='text-sm md:text-md hover:text-lime-400 border-2 hover:border-lime-400 rounded-full px-2 md:px-5 py-1 font-mono'>Series</Link></li>
                <li>
                    <Link href="#">
