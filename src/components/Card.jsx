  ...
  return (
    <div className='w-5/6 md:w-72 bg-neutral-200 max-h-60 rounded-lg hover:bg-lime-500 overflow-hidden'>
        <Link href={blogUrl ? blogUrl : ""}>
            <img src={imageUrl} alt="na" className='w-full aspect-video '/>
            ...
            <div className='flex items-center justify-between px-3'>
              ...
              {blogUrl ? "" : <p className='text-neutral-500 font-bold px-3 border-2 bg-neutral-200 border-lime-500 rounded-md'>Writting</p>}
            </div>
        </Link>
    </div>
  )
